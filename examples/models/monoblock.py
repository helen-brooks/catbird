...
class MonoblockModel(MooseModel):
    ...
    def _concretise_model(self):
        ...
        self.add_material("tungsten_thermal_conductivity",
                           "PiecewiseLinearInterpolationMaterial",
                           xy_data=[20, 173,
                                    50, 170,
                                    100, 165,
        ...
        # Densities
        self.add_material("cucrzr_density",
                           "PiecewiseLinearInterpolationMaterial",
                           xy_data=[20, 8900,
                                    50, 8886,
                                    100, 8863,
        ...
        self.add_material("copper_density",
                           "PiecewiseLinearInterpolationMaterial",
                           xy_data=[20, 8940,
                                    50, 8926,
                                    100, 8903,
        ...
        self.add_material("tungsten_density",
                           "PiecewiseLinearInterpolationMaterial",
                           xy_data=[20,  19300,
                                    50,  19290,
                                    100, 19280,
        ...
        # Specific heats
        self.add_material("cucrzr_specific_heat",
                           "PiecewiseLinearInterpolationMaterial",
                           xy_data=[20, 390,
                                    50, 393,
                                    100, 398,
        ...
        self.add_material("copper_specific_heat",
                           "PiecewiseLinearInterpolationMaterial",
                           xy_data=[20, 388,
                                    50, 390,
                                    100, 394,
        ...
        self.add_material("tungsten_specific_heat",
                           "PiecewiseLinearInterpolationMaterial",
                           xy_data=[20, 129,
                                    50, 130,
                                    100, 132,
        ...
        self.add_material("coolant_heat_transfer_coefficient",
                           "PiecewiseLinearInterpolationMaterial",
                           xy_data=[1, 4,
                                    100, 109.1e3,
                                    150, 115.9e3,
